...
root.title('Tic Tac Toe Advanced')
root.configure(background = 'Cadet Blue')

Tops = Frame(root, bg = 'Cadet Blue', pady = 2, width = 1350, height = 100, relief = RIDGE)
Tops.grid(row = 0, column = 0)

labelTitle = Label(Tops, font = ('arial', 50, 'bold'), text = 'Tic Tac Toe Advanced', bd = 21, bg = 'Cadet Blue', fg = 'Cornsilk', justify = CENTER)
...
def scoreKeeper():
    ...
    if(button1["text"] == "O" and button2["text"] == "O" and button3["text"] == "O"):
        ...
        score = (n + 1)
        playerX.set(score)
        tkinter.messagebox.showinfo("Player O", "You Win!")
...
labelPlayerX = Label(rightFrame1, font = ('arial', 40, 'bold'), text = 'Player X: ', padx = 2, pady = 2, bg = 'Cadet Blue')
...
labelPlayerO = Label(rightFrame1, font = ('arial', 40, 'bold'), text = 'Player O: ', padx = 2, pady = 2, bg = 'Cadet Blue')
...
buttonReset = Button(rightFrame2, text = "Reset", font = ('arial', 40, 'bold'), height = 1, width = 20, command = reset)
buttonReset.grid(row = 2, column = 0, padx = 6, pady = 11)

buttonNewGame = Button(rightFrame2, text = "New Game", font = ('arial', 40, 'bold'), height = 1, width = 20, command = NewGame)
